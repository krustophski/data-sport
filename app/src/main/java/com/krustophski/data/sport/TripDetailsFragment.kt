...
import com.krustophski.data.sport.util.configureGoogleFit
import com.krustophski.data.sport.util.getCaloriesBurnedLabel
import com.krustophski.data.sport.util.getDatasets
import com.krustophski.data.sport.util.getGoogleAccount
import com.krustophski.data.sport.util.getSpeedDataFromGps
import com.krustophski.data.sport.util.getSpeedDataFromSensor
import com.krustophski.data.sport.util.getTrendData
import com.krustophski.data.sport.util.hasFitnessPermissions
import com.krustophski.data.sport.util.useBleSpeedData
import com.krustophski.data.sport.widgets.AxisLabelOrientation
import com.krustophski.data.sport.widgets.AxisLabels
import com.krustophski.data.sport.widgets.BordersEnum
import com.krustophski.data.sport.widgets.Entry
import com.krustophski.data.sport.widgets.HeadingView
import com.krustophski.data.sport.widgets.LineGraph
import com.krustophski.data.sport.widgets.LineGraphAreaDataset
import com.krustophski.data.sport.widgets.LineGraphDataset
...
class TripDetailsFragment : Fragment(), View.OnTouchListener {
    ...
    private fun getCaloriesBurned(
        ...
        try {
            com.krustophski.data.sport.util.getCaloriesBurned(
                requireContext(),
                biometrics,
                overview,
                avgHr,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (getGoogleAccount(requireContext()) == null) {
            Log.i(logTag, "Google account not available; skipping auto sign-in")
        }
