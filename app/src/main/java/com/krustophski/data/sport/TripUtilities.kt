...
import com.krustophski.data.sport.data.DerivedTripState
import com.krustophski.data.sport.data.HeartRateMeasurement
import com.krustophski.data.sport.util.FEET_TO_INCHES
import com.krustophski.data.sport.util.FEET_TO_METERS
import com.krustophski.data.sport.util.FEET_TO_MILES
import com.krustophski.data.sport.util.INCHES_TO_FEET
import com.krustophski.data.sport.util.METERS_TO_FEET
import com.krustophski.data.sport.util.METERS_TO_KM
import com.krustophski.data.sport.util.METERS_TO_MM
import com.krustophski.data.sport.util.SECONDS_TO_HOURS
import com.krustophski.data.sport.util.SystemUtils
import com.krustophski.data.sport.util.getPreferences
...
import com.krustophski.data.sport.util.kelvinToCelsius
import com.krustophski.data.sport.util.kelvinToFahrenheit
