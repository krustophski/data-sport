...
import com.krustophski.data.sport.events.StartTripEvent
import com.krustophski.data.sport.events.TripProgressEvent
...
class TripInProgressService @Inject constructor() :
    ...
    private suspend fun getCombinedBiometrics(id: Long): Biometrics =
        com.krustophski.data.sport.util.getCombinedBiometrics(
            id,
