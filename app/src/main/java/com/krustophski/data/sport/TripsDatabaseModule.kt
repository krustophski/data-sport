...
import com.krustophski.data.sport.data.SensorType
import com.krustophski.data.sport.util.getBikeMassOrNull
...
val MIGRATION_28_29 = object : Migration(28, 29) {
    override fun migrate(db: SupportSQLiteDatabase) {
        db.execSQL("ALTER TABLE `OnboardSensors` ADD COLUMN `accelerometerX` FLOAT")
        db.execSQL("ALTER TABLE `OnboardSensors` ADD COLUMN `accelerometerY` FLOAT")
        db.execSQL("ALTER TABLE `OnboardSensors` ADD COLUMN `accelerometerZ` FLOAT")
        db.execSQL("ALTER TABLE `OnboardSensors` ADD COLUMN `magneticX` FLOAT")
        db.execSQL("ALTER TABLE `OnboardSensors` ADD COLUMN `magneticY` FLOAT")
        db.execSQL("ALTER TABLE `OnboardSensors` ADD COLUMN `magneticZ` FLOAT")
    }
}
